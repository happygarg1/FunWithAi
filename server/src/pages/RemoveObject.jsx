...
const RemoveObject = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    if (object.trim().split(" ").length > 1) {
      return toast.error("Provide a single object name only.");
    }
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <textarea
          ...
          placeholder="Only single object name allowed..."
          required
        />
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-[24rem]">
        ...
        {!content ? (
          ...
          <img src={content} alt="Processed" className="mt-3 w-full h-full object-contain rounded" />
        )}
      </div>
    </div>
  );
